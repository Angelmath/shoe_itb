...
import com.example.myapplication.databinding.FragmentAdministradorUsuarioBinding;

public class AdministradorUsuarioFragment extends Fragment {

    private FragmentAdministradorUsuarioBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentAdministradorUsuarioBinding.inflate(inflater, container, false);
    ...
    public void onCickRegistarSQL(String txt_nombre, String txt_apellido, String txt_correo, String txt_contrasenia){
        ...
        String query = "insert into "+ ConstantesDB.NOMBRE_TABLA_USUARIO +" ( "+ConstantesDB.CAMPO_NOMBRE+", "+ConstantesDB.CAMPO_APELLIDO+", "+ConstantesDB.CAMPO_EMAIL+", "+ConstantesDB.CAMPO_CONSTRASENIA+", "+ConstantesDB.CAMPO_ROL+" ) "
                + " values ( '"+ txt_nombre +"', '"+txt_apellido+"', '"+txt_correo+"', '"+txt_contrasenia+"','Admin' )" ;
